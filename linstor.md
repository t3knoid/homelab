...
Each Proxmox node has a secondary 500Gb SSD that that will be used to create the Linstor storage pools. The [[Linstor Setup Guide]] provides detailed steps on setting up a Linstor storage. 
